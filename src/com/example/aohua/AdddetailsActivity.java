...
public class AdddetailsActivity extends Activity implements OnTouchListener, android.view.View.OnClickListener{
	...
	private Handler handler1=new Handler(){
		...
		public void handleMessage(Message msg) {
			if(msg.what==0){
				Toast.makeText(AdddetailsActivity.this,"网络连接失败！", Toast.LENGTH_LONG).show();
			}else{
				try {
					...
					builder.setItems(items, new DialogInterface.OnClickListener()  
				       {  
				           ...
				           {  
				               ...
				               Toast.makeText(AdddetailsActivity.this, "选择的物料id为：" + GoodsID, Toast.LENGTH_SHORT).show();
				           }  
				       });  
					builder.create().show();
			 ...
			 new AlertDialog.Builder(this).setTitle("确定提交这条明细吗？") 
	            ...
	            .setPositiveButton("确定", new DialogInterface.OnClickListener() { 	         
	                ...
	                // 点击“确认”后的操作 
	                	...
	                	AdddetailsActivity.this.setResult(Activity.RESULT_OK, intent);//返回页面1
	                	AdddetailsActivity.this.finish();
	                } 
	            }) 
	            .setNegativeButton("取消", new DialogInterface.OnClickListener() { 
